...
public class ClientEventHandler {
    ...
    public void onMakeTooltip(ItemTooltipEvent evt) {
        ...
        if (ConfigBuildHandler.SLEEP_TIMINGS_CONFIG.timeClock.get() && this.mc.world != null && evt.getItemStack().getItem() == Items.CLOCK) {

            long time = this.mc.world.getDayTime();
            String s = TimeFormatHelper.formatTime(time);
            evt.getToolTip().add(1, new StringTextComponent(s).func_230530_a_(Style.field_240709_b_.func_240718_a_(Color.func_240744_a_(TextFormatting.GRAY))));
